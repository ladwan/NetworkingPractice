...
{
    public class CameraScreenShakeManager : MonoBehaviour
    {
        [SerializeField] Transform cameraTransform = null;


        private static CameraScreenShakeManager instance = null;
        private CharAbility.CameraShakeParameters testParams = new CharAbility.CameraShakeParameters();


        public static CameraScreenShakeManager Instance { get => instance; set => instance = value; }
